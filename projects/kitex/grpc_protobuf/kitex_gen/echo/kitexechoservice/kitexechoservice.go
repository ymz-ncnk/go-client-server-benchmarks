...
import (
	...
	echo "github.com/ymz-ncnk/go-client-server-communication-benchmarks/projects/kitex/grpc_protobuf/kitex_gen/echo"
)
...
var (
	kitexEchoServiceServiceInfo                = NewServiceInfo()
	kitexEchoServiceServiceInfoForClient       = NewServiceInfoForClient()
	kitexEchoServiceServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return kitexEchoServiceServiceInfo
}

// for stream client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return kitexEchoServiceServiceInfoForStreamClient
}

// for client
func serviceInfoForClient() *kitex.ServiceInfo {
	return kitexEchoServiceServiceInfoForClient
}
...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	serviceName := "KitexEchoService"
	handlerType := (*echo.KitexEchoService)(nil)
...
func echoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(echo.KitexData)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(echo.KitexEchoService).Echo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *EchoArgs:
		success, err := handler.(echo.KitexEchoService).Echo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *kClient) Echo(ctx context.Context, Req *echo.KitexData) (r *echo.KitexData, err error) {
	var _args EchoArgs
	_args.Req = Req
