...
const (
	EchoCmdDTM com.DTM = iota + 1
)

const (
	EchoResultDTM com.DTM = iota + 1
)
...
func (s cmdMUS) Marshal(v core.Cmd[Receiver], w mus.Writer) (n int, err error) {
	switch t := v.(type) {
	case EchoCmd:
		return EchoCmdTypedMUS.Marshal(t, w)
	default:
		panic(fmt.Sprintf(com.ErrorPrefix+"unexpected %v type", t))
	}
}

func (s cmdMUS) Unmarshal(r mus.Reader) (v core.Cmd[Receiver], n int, err error) {
...
func (s cmdMUS) Size(v core.Cmd[Receiver]) (size int) {
	switch t := v.(type) {
	case EchoCmd:
		return EchoCmdTypedMUS.Size(t)
	default:
		panic(fmt.Sprintf(com.ErrorPrefix+"unexpected %v type", t))
	}
}
...
func (s resultMUS) Marshal(v core.Result, w mus.Writer) (n int, err error) {
	switch t := v.(type) {
	case EchoResult:
		return EchoResultTypedMUS.Marshal(t, w)
	default:
		panic(fmt.Sprintf(com.ErrorPrefix+"unexpected %v type", t))
	}
}
...
func (s resultMUS) Size(v core.Result) (size int) {
	switch t := v.(type) {
	case EchoResult:
		return EchoResultTypedMUS.Size(t)
	default:
		panic(fmt.Sprintf(com.ErrorPrefix+"unexpected %v type", t))
	}
}
