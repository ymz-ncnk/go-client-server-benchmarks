...
const file_cmds_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"cmds.proto\x12\atcproto\x1a\n" +
	"data.proto\";\n" +
	"\aEchoCmd\x120\n" +
	"\n" +
	"proto_data\x18\x01 \x01(\v2\x11.common.ProtoDataR\tprotoDataB[ZYgithub.com/ymz-ncnk/go-client-server-communication-benchmarks/projects/cmd-stream/tcprotob\x06proto3"

var (
	file_cmds_proto_rawDescOnce sync.Once
	file_cmds_proto_rawDescData []byte
)

func file_cmds_proto_rawDescGZIP() []byte {
	file_cmds_proto_rawDescOnce.Do(func() {
		file_cmds_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cmds_proto_rawDesc), len(file_cmds_proto_rawDesc)))
	})
	return file_cmds_proto_rawDescData
}

var file_cmds_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_cmds_proto_goTypes = []any{
	(*EchoCmd)(nil),          // 0: tcproto.EchoCmd
	(*common.ProtoData)(nil), // 1: common.ProtoData
}
var file_cmds_proto_depIdxs = []int32{
	1, // 0: tcproto.EchoCmd.proto_data:type_name -> common.ProtoData
...
func file_cmds_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cmds_proto_rawDesc), len(file_cmds_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
